        ...
        for (const line of lines) {
          if (line.startsWith('data: ')) {
            ...
            if (chunk === '[DONE]') {
              ...
              //   console.log('DEBUG: Raw chunk received:', JSON.stringify(chunk));
              //   console.log('DEBUG: Unescaped chunk:', JSON.stringify(unescapedChunk));
              //   console.log('DEBUG: Unescaped contains newlines:', unescapedChunk.includes('\n'));
              // }
